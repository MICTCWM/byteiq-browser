...
function getDomReferences(documentRef) {
  return {
    ...
    aiProfileSelect: documentRef.getElementById('ai-profile-select'),
    aiProfileAddBtn: documentRef.getElementById('ai-profile-add-btn'),
    aiProfileDeleteBtn: documentRef.getElementById('ai-profile-delete-btn'),
    aiProfileApplyBtn: documentRef.getElementById('ai-profile-apply-btn'),
    aiProfileNameInput: documentRef.getElementById('ai-profile-name-input'),
